    ...
    <main className="min-h-screen bg-[#050816] text-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
          Learn how to compress videos, optimize images, manage PDFs, and grow faster with smart tools.
        </p>
      </section>
      ...
      {/* ================= QUICK TOOLS ================= */}
      <section className="max-w-6xl mx-auto px-6 mb-16">
        <h2 className="text-xl font-semibold mb-6">Use Tools Instantly</h2>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20 text-center">
        <div className="p-8 rounded-2xl bg-white/5 border border-white/10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="https://creatorcloud.in/video/compress" target="_blank" className="px-5 py-2 bg-white/10 rounded-lg">
              Video Compressor
            </a>

            <a href="https://creatorcloud.in/image/compress" target="_blank" className="px-5 py-2 bg-white/10 rounded-lg">
              Image Compressor
            </a>

            <a href="https://creatorcloud.in/pdf/merge" target="_blank" className="px-5 py-2 bg-white/10 rounded-lg">
              PDF Tools
            </a>
